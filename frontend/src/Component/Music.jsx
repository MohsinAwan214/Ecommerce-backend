...
<div className="ml-12  h-full  max-w-96  flex flex-col  justify-between py-10 ">
  ...
  <div className='flex text-black gap-5  '>
   ...
   <ul className="bg-white h-12 w-12 rounded-full z-10 px-2 bg-center  flex-col ">
   ...
   <ul className="bg-white h-12 w-12 rounded-full z-10  bg-center  flex-col  ">
